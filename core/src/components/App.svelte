...
<!-- The social hub is mounted OUTSIDE #startMenuWrapper: that wrapper is
     display:none while a game is running, and the hub must open from the
     in-game scoreboard too. The Modal itself is fixed-position, so mounting at
     the App root works in both the menu and the game. -->
<Modal
	open={st.menuModal === "social"}
	title="VERTIX SOCIAL"
	wide
	scrollable={false}
	onclose={closeMenuModal}
>
	<div class="menuModalContent menuModalScroll"><SocialHub /></div>
</Modal>
<div id="linkBoxRight">
...
<div id="creditsBox">
	<a id="creditsLink" target="_blank" rel="noopener" href="https://github.com/KrunkerRevivalProject/vertix">
		Original Vertix by theGu5, Dreamery &amp; Dragonn44
	</a>
</div>
